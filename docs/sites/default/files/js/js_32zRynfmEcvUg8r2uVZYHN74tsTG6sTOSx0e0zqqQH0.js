(function ($) {
  ...
  Drupal.behaviors.dcco_register = {
    ...
    attach: function(context) {
      ...
      var pricePoints = $('<div class="dcco-register-price-points no-bullets clearfix"></div>');
      ...
      function scrollToSubmit() {
        $('html, body').animate({
          scrollTop: $("#edit-submit").offset().top - 100
        }, 2000);
      }
      ...
      $('<div class="item dcco-register-price-points--free"><div class="">' + Drupal.t('<span>FREE</span>') + '</div></div>')
        .click(function(e){
          e.preventDefault();
      ...
      $('<div class="item dcco-register-price-points--25"><div class="">' + Drupal.t('<span><span class="currency">$</span>25</span><span class="level">Contributor</span>') + '</div></div>')
        .click(function(e){
          e.preventDefault();
      ...
      $('<div class="item dcco-register-price-points--50"><div class="">' +  Drupal.t('<span><span class="currency">$</span>50</span><span class="level">Yeti</span>') + '</div></div>')
        .click(function(e){
          e.preventDefault();
      ...
      $('<p>Register early! Admission to the camp is free, but the first 150 contributors of $25 or more to support the camp and community will receive an awesome camp t-shirt.</p>').prependTo('#dcco-register-registration');
...
(function($){
  Drupal.behaviors.emplementMenu = {
    attach: function (context, settings) {
      $('#page', context).once('drupal-menu', function(){
        ...
        if ($('#block-system-user-menu', context).length) {
          var userNav = responsiveNav('block-system-user-menu', {
            label: '<span class="mobile-user-menu icon-user"></span>'
          });
        };
      });
    }
